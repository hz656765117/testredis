...
public class FindGroupSignAPI extends BaseController {
	...
	@Resource GroupService groupService;
		...
		public void findUserSign(HttpServletRequest request ,HttpServletResponse response,@ModelAttribute("baseModel") BaseModel baseModel,Model model) throws IOException{
			...
			List<Sign> list =  signService.findUserSign(baseModel.getGroupId(), baseModel.getUserId());
		...
		public void getSystemTime(HttpServletRequest request ,HttpServletResponse response,@ModelAttribute("baseModel") BaseModel baseModel,Model model) throws IOException{
